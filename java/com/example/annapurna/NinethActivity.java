...
public class NinethActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv9a = findViewById(R.id.tv9a);
        tv9b = findViewById(R.id.tv9b);
        ...
        tv9a.setText(receivedValue1);
        tv9b.setText(receivedValue2);
            ...
            public void onClick(View view) {
                ...
                builder.setPositiveButton("YES", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int which) {
                        ...
                        intent.putExtra("COACH_SENDER",tv9b.getText().toString());
                        intent.putExtra("SEAT_SENDER",tv9a.getText().toString());
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent2.putExtra("COACH_SENDER",tv9b.getText().toString());
                intent2.putExtra("SEAT_SENDER",tv9a.getText().toString());
        ...
        reference = FirebaseDatabase.getInstance().getReference().child("annapurna6");
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                taskAdapter = new TaskAdapter(NinethActivity.this, list);
