...
public class FourthActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv4a = findViewById(R.id.tv4a);
        tv4b = findViewById(R.id.tv4b);
        ...
        tv4a.setText(receivedValue1);
        tv4b.setText(receivedValue2);
            ...
            public void onClick(View view) {
                ...
                builder.setPositiveButton("YES", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int which) {
                        ...
                        intent.putExtra("COACH_SENDER",tv4b.getText().toString());
                        intent.putExtra("SEAT_SENDER",tv4a.getText().toString());
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent2.putExtra("COACH_SENDER",tv4b.getText().toString());
                intent2.putExtra("SEAT_SENDER",tv4a.getText().toString());
        ...
        reference = FirebaseDatabase.getInstance().getReference().child("annapurna1");
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                taskAdapter = new TaskAdapter(FourthActivity.this, list);
