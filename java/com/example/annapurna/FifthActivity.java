...
public class FifthActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv5a = findViewById(R.id.tv5a);
        tv5b = findViewById(R.id.tv5b);
        ...
        tv5a.setText(receivedValue1);
        tv5b.setText(receivedValue2);
            ...
            public void onClick(View view) {
                ...
                builder.setPositiveButton("YES", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int which) {
                        ...
                        intent.putExtra("COACH_SENDER",tv5b.getText().toString());
                        intent.putExtra("SEAT_SENDER",tv5a.getText().toString());
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent2.putExtra("COACH_SENDER",tv5b.getText().toString());
                intent2.putExtra("SEAT_SENDER",tv5a.getText().toString());
        ...
        reference = FirebaseDatabase.getInstance().getReference().child("annapurna2");
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                taskAdapter = new TaskAdapter(FifthActivity.this, list);
